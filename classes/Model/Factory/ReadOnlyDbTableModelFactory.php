 ...
 * @author ktogias
 */
class ReadOnlyDbTableModelFactory implements FactoryInterface{
    ...
    public function createService(ServiceLocatorInterface $serviceLocator) {
        ...
        /* @var $model KtogiasZendLib\Model\DbTableModelInterface */
        $table = $serviceLocator->get($this->tableClass);
        /*@var $table KtogiasZendLib\Db\Table\DbTableInterface */
        $table->getTableGateway()->getResultSetPrototype()->setArrayObjectPrototype($model);
